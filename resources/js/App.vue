<template>
  <div class="min-h-screen flex flex-col bg-slate-50 text-slate-900">
    <header class="bg-blue-700 text-white px-4 py-3 shadow">
      ...
      <p class="text-xs opacity-90">Pengingat otomatis 3× sehari (16.30 / 20.30 / 23.00 WITA)</p>
    </header>
    ...
    <footer class="text-center text-xs text-slate-500 p-3 border-t border-slate-200">
      Batas absen: <strong>tengah malam (00.00 WITA)</strong> · <a href="https://monev.maganghub.kemnaker.go.id/dashboard/riwayat" target="_blank" rel="noopener" class="text-blue-700 underline">Dashboard MagangHub</a>
    </footer>
  </div>
</template>
